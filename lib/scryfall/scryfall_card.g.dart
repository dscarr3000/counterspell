...
_ScryfallCard _$ScryfallCardFromJson(Map<String, dynamic> json) =>
    _ScryfallCard(
      ...
      previewedAt: json['preview.previewed_at'] == null
          ? null
          : DateTime.parse(json['preview.previewed_at'] as String),
      previewSourceUri: json['preview.source_uri'] == null
          ? null
          : Uri.parse(json['preview.source_uri'] as String),
      previewSource: json['preview.source'] as String?,
    );
...
Map<String, dynamic> _$ScryfallCardToJson(
  ...
  'preview.previewed_at': instance.previewedAt?.toIso8601String(),
  'preview.source_uri': instance.previewSourceUri?.toString(),
  'preview.source': instance.previewSource,
};
